...
$(document).ready(function () {
    ...
    function fetchData(page = 1) {
        $.ajax({
            url: "backend/attendanceReports.php", // Change this to your backend PHP script
            type: "GET",
            data: { page: page },
            dataType: "json",
        })
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var reportTable = document.getElementById("attendanceReportsTable");
